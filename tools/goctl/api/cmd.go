...
func init() {
	...
	Cmd.Flags().StringVar(&apigen.VarStringRemote, "remote", "", "The remote git repo of the"+
		...
		" https://github.com/jiangz222/go-zero-template directory structure")
	...
	goCmd.Flags().StringVar(&gogen.VarStringStyle, "style", "gozero", "The file naming format,"+
		" see [https://github.com/jiangz222/go-zero/blob/master/tools/goctl/config/readme.md]")
	...
	pluginCmd.Flags().StringVar(&plugin.VarStringStyle, "style", "",
		"The file naming format, see [https://github.com/jiangz222/go-zero/tree/master/tools/goctl/config/readme.md]")
