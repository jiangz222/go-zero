...
func init() {
	...
	ddlCmd.Flags().StringVar(&command.VarStringStyle, "style", "", "The file naming format, see [https://github.com/jiangz222/go-zero/tree/master/tools/goctl/config/readme.md]")
	...
	datasourceCmd.Flags().StringVar(&command.VarStringStyle, "style", "", "The file naming format, see [https://github.com/jiangz222/go-zero/tree/master/tools/goctl/config/readme.md]")
	...
	pgDatasourceCmd.Flags().StringVar(&command.VarStringStyle, "style", "", "The file naming format, see [https://github.com/jiangz222/go-zero/tree/master/tools/goctl/config/readme.md]")
	...
	mongoCmd.Flags().StringVar(&mongo.VarStringStyle, "style", "", "The file naming format, see [https://github.com/jiangz222/go-zero/tree/master/tools/goctl/config/readme.md]")
